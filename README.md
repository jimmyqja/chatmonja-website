...
- `contact.html` — privacy-focused tester contact form and Instagram link
...
The download buttons use the exact GitHub release tag (`releases/download/v1.3.4/...`). GitHub’s `releases/latest/download/...` route does not include releases marked as pre-release. Update the tag, asset names, and displayed version together for each future release.
